...
!function(e){
    ...
    e(".menu-item.has-submenu .menu-link").on("click", function(s) {
      s.preventDefault();
      if (e(this).next(".submenu").is(":hidden")) {
    ...
    if (e(".select-nice").length) {
      e(".select-nice").select2();
    }
  
    if (document.querySelector("#offcanvas_aside")) {
      const el = document.querySelector("#offcanvas_aside");
